...
@section('title')Add Stat Counter -  {{ config('app.name', 'Laravel') }} @endsection
@section('content')
<div class="content">
    <!-- Start Content-->
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Add Stat Counter</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Add Stat Counter</h4>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="stat_counter" value="{{old('stat_counter')}}" id="stat_counter" required>
                                    </div>
                                </div>
                            </div>
