...
@section('title')Edit Award -  {{ config('app.name', 'Laravel') }} @endsection
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="text-xl-end">
                            <a href="{{route('awards.index')}}" class="btn btn-success ">View Award</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{route('awards.update',$award->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">  
                                <div class="col-lg-6">
                                    <img id="preview-image-before-upload"  style="max-height:150px;" src="{{asset('uploads/award/'.$award->image)}}">
                                </div>
                            </div> 
                            <div class="text-xl-end">
