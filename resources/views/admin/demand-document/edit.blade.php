        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{route('demand-document.update',$document->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            @if ($document->image!=null)
                                                <img id="preview-image-before-upload" src="{{ asset('uploads/documents/demand/'.$document->image) }}" style="max-height:150px;">
                                            @else
                            ...
                            <div class="col-lg-7 col-xxl-7">
                                <div class="card h-600">
                                    <div class="card-body">
                                        ...
                                        <textarea name="content" required>{{old('content',$document->content)}}</textarea>
