    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('callbacks.index')}}">Enquiries</a></li>
        ...
        <div class="row mb-3">
            <div class="text-xl-end">
                <a href="{{route('callbacks.index')}}" class="btn btn-success">View Enquiries</a>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        <div>
                                            ...
                                            <p class="font-16 text-white mb-0"> Address: {{$message->address}}</p>
