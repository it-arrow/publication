                ...
                <div class="card">
                    <div class="card-header">
                        <div class="text-xl-end">
                            <a href="{{route('subcategories.index')}}" class="btn btn-success ">View Category</a>
                        </div>
                    </div>
                    <div class="card-body">
                        @include('admin.includes.message')
                        <form action="{{route('subcategories.update',$sub_cat->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
