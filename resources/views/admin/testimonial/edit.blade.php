                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <img id="preview-image-before-upload" @if($testimonial->image!=null) src="{{asset('uploads/testimonials/'.$testimonial->image)}}" @endif style="max-height:150px;">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label>Message (max:255 characters)</label><span class="text-danger"> * </span>
                                <textarea class="form-control" name="message" rows="5" required>{{old('message',$testimonial->message)}}</textarea>
                            </div>
                        </div>
                    </div> 
