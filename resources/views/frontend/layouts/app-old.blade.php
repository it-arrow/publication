...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-253104742-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'UA-253104742-2');
    </script>
    ...
    <link rel="stylesheet" href="{{asset('frontend/assets/css/googlelanguage.css')}}">
    <!--TITLE-->
