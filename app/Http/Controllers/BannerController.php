...
class BannerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('m_image')) {
            $imageName = time().'m.'.$request->image->extension();  
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($m_image = $request->file('m_image')) {
            if($banner->m_image!=null){
                $image_path = public_path('uploads/banners/' . $banner->m_image);
            ...
            $destinationPath = 'uploads/banners/';
            $profileImage = date('YmdHis') . "m." .$m_image->getClientOriginalName();
            $m_image->move($destinationPath, $profileImage);
            $banner->m_image = "$profileImage";
            
        }else{
            unset($banner->m_image);
        }
        $banner->update();
